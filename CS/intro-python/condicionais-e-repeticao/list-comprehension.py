...
frase = "O módulo de CS é bom de mais, as dicas pythônicas fazem ficar melhor ainda"
vogais = "aeiou"
...
dict_vogais = {f'{letra.upper()}': f'{letra.lower()}' for letra in frase if letra in vogais}
dict_consoantes = {f'{letra.upper()}': f'{letra.lower()}'
                    for letra in frase 
                    if letra not in vogais}
print(dict_vogais)
